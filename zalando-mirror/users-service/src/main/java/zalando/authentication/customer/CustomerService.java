...
public class CustomerService {
    ...
    public UserDetails getCustomerDetailsByID(Long ID) {
        var customer = customerRepository.findCustomerById(ID);
        UserDetails userDetails = new UserDetails();
        userDetails.setAddress(customer.get().getAddress());
        userDetails.setId(customer.get().getId());
        userDetails.setCreditCardNumber(customer.get().getCreditCardNumber());
        return userDetails;
    }
